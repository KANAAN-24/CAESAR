...
void doForwardWithEncoder(){
  ...
  else{ steering.write(steeringPID);/* motion_mode=STOP;*/ forward(255);}
  } 
//*****************************
void doTurnEncoder(){
...
void doTurn(){
    ...
    if(abs(currentAngle-initAngle)>=80 && encoder_count>1250){ steering.write(STRAIGHT_STEERING); rounCounter++; 
